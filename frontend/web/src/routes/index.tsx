	...
	return (
		<div className="mx-auto flex max-w-3xl flex-col items-start px-4 pb-16 pt-8 sm:px-6 sm:pt-20">
			...
			<h1 className="text-balance text-3xl font-semibold leading-[1.15] tracking-tight sm:text-5xl sm:leading-[1.1]">
				Comprendre ce qui se décide à Poitiers et&nbsp;Grand&nbsp;Poitiers, sans
			...
			<p className="mt-5 max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground sm:mt-6 sm:text-xl sm:leading-normal">
				Délibérations, indicateurs, engagements&nbsp;: l'activité de vos
				conseils municipaux et communautaires, rendue lisible et consultable.
			</p>
			...
			<div className="mt-16 max-w-2xl border-t border-border pt-6 sm:mt-20 sm:pt-8">
				<p className="text-sm leading-relaxed text-muted-foreground">
					La Vigie Citoyenne agrège et met en récit des données publiques déjà
					accessibles. Elle est pensée comme un bien commun numérique local,
					utile quelle que soit la majorité en place. Sa gouvernance est appelée
					à évoluer pour accueillir d'autres contributeurs civiques.
				</p>
			</div>
		</div>
	);
