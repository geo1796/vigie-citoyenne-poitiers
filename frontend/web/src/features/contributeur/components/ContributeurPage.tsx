  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <div className="space-y-2">
        ...
        {session && (
          <p className="text-sm text-muted-foreground">Connecté en tant que {session.email}</p>
        )}
      </div>
      ...
      <div className="space-y-4">
        <p className="text-xs uppercase tracking-wider text-muted-foreground">Sécurité</p>
        <Link
          to="/password-reset"
          className="inline-block text-sm text-primary underline-offset-4 hover:underline"
        >
