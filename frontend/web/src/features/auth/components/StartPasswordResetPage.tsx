...
export function StartPasswordResetPage() {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      start.mutate(value, {
        onSuccess: () => toast.success('Un lien de réinitialisation vous a été envoyé.'),
        onError: (_) => toast.error('Une erreur est survenue.'),
      });
    },
  });
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col justify-center px-4">
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">Réinitialisation</h1>
