  ...
  return (
    <div className="mx-auto max-w-sm space-y-8">
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">Inviter un contributeur</h1>
        <p className="text-sm text-muted-foreground">
          Un lien d'inscription sera envoyé à cette adresse. La personne choisira elle-même son mot
          de passe.
        </p>
      </div>
