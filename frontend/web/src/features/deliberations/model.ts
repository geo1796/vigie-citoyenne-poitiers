...
export type ListDeliberationsParams = z.infer<
	typeof listDeliberationsParamsSchema
>;
...
export type ListDeliberationsResult = z.infer<
	typeof listDeliberationsResultSchema
>;
...
export type FindDeliberationResult = z.infer<
	typeof findDeliberationResultSchema
>;
